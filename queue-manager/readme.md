...
First, you need to add `@arthur2079/wallets-react` to your project
...
```
yarn add @arthur2079/queue-manager-core @arthur2079/queue-manager-react @arthur2079/queue-manager-rango-preset


# or using NPM

npm install @arthur2079/queue-manager-core @arthur2079/queue-manager-react @arthur2079/queue-manager-rango-preset
```

You can also install the individual packages separately:

```
npm install @arthur2079/queue-manager-core
npm install @arthur2079/queue-manager-react
npm install @arthur2079/queue-manager-rango-preset
```
...
```js
import { Provider } from '@arthur2079/queue-manager-react';
import { SwapQueueContext, makeQueueDefinition } from '@arthur2079/queue-manager-rango-preset';
